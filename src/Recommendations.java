...
public class Recommendations {
    ...
    public void setCollatedRides(ArrayList<Ride> collatedRides) {
        this.collatedRides = collatedRides;
    }

    public ArrayList<Ride> getCollatedRides() {
        return collatedRides;
    }
 ...
 */
    public ArrayList<Ride> allRides(ArrayList<Ride> ridesArray) throws IOException, InterruptedException {
        allRidesNow = true;
